...
**Inferred protected characteristics for screening:** Using Scout or any other AI to infer, estimate, or derive candidates' race, ethnicity, disability, religion, sex, age, or other protected characteristics under Equality Act 2010 section 4 for any screening, scoring, or filtering purpose. The ICO has confirmed that inferred protected-characteristic data is unlikely to be accurate enough to support lawful bias monitoring and will typically lack a valid lawful basis and additional condition (ICO AI in Recruitment Outcomes Report, November 2024).
