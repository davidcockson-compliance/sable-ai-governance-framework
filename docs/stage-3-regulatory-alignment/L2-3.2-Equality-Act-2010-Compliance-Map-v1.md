...
### 4.4 Objective Justification Test
...
### 4.5 Reasonable Adjustments Duty (EA 2010, s.20)
...
3. **Positive action implementation:** The parameters of lawful positive action under s.158 (general) and s.159 (recruitment and promotion) EA 2010 in the context of AI-assisted shortlisting require legal advice before any such programme is implemented. In particular, the equal-merit assessment required by s.159 must not be operationalised through Scout's scoring or ranking logic.
...
| `L2-3.3-ICO-Audit-Gap-Analysis-v1.md` | ICO enforcement posture on AI discrimination in recruitment |
| `L3-4.2-Bias-Monitoring-Protocol-v1.md` | Operational bias detection and audit methodology |
| `L4-5.2-Candidate-Transparency-Notice-v1.md` | Candidate notice covering right to human review and right to contest |
