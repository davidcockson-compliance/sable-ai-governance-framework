...
Because we use AI to review your application, you have specific rights under UK law (the Data (Use and Access) Act 2025, which amended UK GDPR Articles 22A–22C):
...
- **Scout / Sable AI Ltd** — to carry out the AI screening of your application. Sable AI Ltd acts as our data processor and processes your data only on our instructions.
...
1. **Section 1 (Who is responsible):** Insert your agency's details as the primary data controller. Include the employer client's name and contact details in the paragraph about acting on behalf of an employer.
